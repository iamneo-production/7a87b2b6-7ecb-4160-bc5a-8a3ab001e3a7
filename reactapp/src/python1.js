...
{return(
     ...
     <div className="content-container">
                  ...
                  <button id="p"><img id="g1"src={require("./tutor1.png")}alt="tutor"/></button><br/>  
                  <h1 id="content">Tutor Name: Mr.Hastings</h1>
                  <h1 id="content">Course Name: Python</h1>
                  <h1 id="content">Rating: 4/5</h1>
                  <h1 id="content">Fees: $36</h1>   
                  <Link to="/payment"><button id="enroll" type="">Enroll</button></Link>
      </div>
      <div>
        <h1 id="modules">Modules</h1>
        <h2 id="modules">1.Mapping in Python</h2>
        <h2 id="modules">2.Oops in Python</h2>
        <h2 id="modules">3.Data Structures in Python</h2>
