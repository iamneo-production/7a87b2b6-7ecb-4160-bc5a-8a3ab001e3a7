  ...
  const handleMouseOut = () => {
    ...
    return(
     ...
     <div className="content-container">
                  <Link to="/"><button id="p"><img id="g1"src={require("./tutor3.png")}alt="tutor"/></button><br/></Link>  
                  <h1 id="content">Tutor Name: Mr.Morgan</h1>
                  <h1 id="content">Course Name: C</h1>
                  <h1 id="content">Rating: 4.1/5</h1>
                  <h1 id="content">Fees: $36</h1>   
                  <Link to="/payment"><button id="enroll">Enroll</button></Link>
